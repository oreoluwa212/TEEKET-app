...
const onGoogleClick = async () => {
  ...
  return (
    <div className=" overflow-hidden lg:w-full lg:h-[800px] lg:pt-10 container font-manrope mx-auto flex max-[420px]:justify-center max-[420px]:mx-5 justify-center text-center mb-6 lg:mt-[10px]">
